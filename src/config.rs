...
pub struct Config {
    ...
    /// Base URL of the srvcs-sin dependency.
    pub sin_url: String,
...
impl Config {
    pub fn from_vars(
        ...
        Config {
            ...
            sin_url: sin_url.unwrap_or_else(|| "http://127.0.0.1:8090".to_string()),
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.sin_url, "http://127.0.0.1:8090");
